...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(),
                "Weather Activity",Toast.LENGTH_SHORT).show();
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CustomRequest customRequest = new CustomRequest(WeatherActivity.this);
    ...
    class CustomRequest extends AsyncTask<String,String,String> {
        ...
        public CustomRequest(WeatherActivity weatherActivity) {
            progressDialog = new ProgressDialog(weatherActivity);
            databaseHandler = new DatabaseHandler(WeatherActivity.this);
        }
        @Override
